...
import { ExamenDetalles } from "../../examenes/@components/ExamenDetalles";
...
export default function EjerciciosResueltoColumna({ dataResueltos }: { dataResueltos: Root2 }) {
