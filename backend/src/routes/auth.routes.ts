...
import {
  colocarPuntaje,
  obtenerExamenesResueltos,
  obtenerExamenResueltoDocumento,
} from "../controllers/testResueltos.controller";
...
router.get("/alumno/dataGeneral", verifyAlumno, obtenerTotalDataPorAlumno);
