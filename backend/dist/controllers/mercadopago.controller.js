...
const client = new mercadopago_1.MercadoPagoConfig({
    accessToken: `APP_USR-4805518848327234-030312-b726ad6fc0a3f60aea5c08a5ad2ea6ec-1516355672`,
});
...
async function recibirVenta(req, res) {
    try {
        ...
        if (action === "payment.created") {
            ...
            const hmac = crypto_1.default.createHmac("sha256", '03c3ba195e0cb7a3e67b990e18d884aa9db163ad459b6f5ef3174f505c06d9a5');
