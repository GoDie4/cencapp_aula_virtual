...
exports.buscarPorNombre = exports.deleteCurso = exports.obtenerCursoPorId = exports.actualizarCurso = exports.showAllCursos = exports.createCurso = exports.uploadImageCurso = void 0;
...
const actualizarCurso = async (req, res) => {
    ...
    const { nombre, precio, horas, categoriaId, descripcion, dirigido, metodologia, certificacion, objetivo } = req.body; // Nuevo nombre de categoría desde req.body
    if (!nombre && !precio && !categoriaId && !horas && !objetivo && !metodologia && !dirigido && !descripcion && !certificacion) {
        res.status(400).json({
