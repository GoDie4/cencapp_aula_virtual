...
export function AlumnoColumnas ({ alum, token, getAlumnos, totalPosts, cantidadRegistros, paginaActual, setpaginaActual }: { alum: Usuario, token: string, getAlumnos: () => Promise<void>, totalPosts: number, cantidadRegistros: number, paginaActual: number, setpaginaActual: (pagina: number) => void }) {
