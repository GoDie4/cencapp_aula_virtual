...
import { ListarProfesores } from '../components/private/tables/profesores/ListarProfesores'
import { AgregarProfesor } from '../components/private/tables/profesores/AgregarProfesor'
      ...
      <AuthProvider>
        <Routes>
          ...
          <Route path="admin" element={<PrivateLayout />}>
            ...
            {/** Profesores */}
            <Route path="profesores" element={<ListarProfesores />} />
